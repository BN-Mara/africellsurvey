...
import com.africell.africellsurvey.databinding.FragmentSettingBinding;
...
public class SettingFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.ipSetting.getEditText().setText(SaveSharedPreference.getShared(getContext(),"ip"));

        binding.ipSetting.getEditText().addTextChangedListener(new TextWatcher() {
            @Override
            ...
            public void afterTextChanged(Editable s) {
                SaveSharedPreference.addToShared(getContext(),"ip",s.toString());
